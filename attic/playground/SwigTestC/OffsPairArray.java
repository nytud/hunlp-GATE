...
public class OffsPairArray {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        TestJNI.delete_OffsPairArray(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public OffsPairArray(int nelements) {
    this(TestJNI.new_OffsPairArray(nelements), true);
  }

  public OffsPair getitem(int index) {
    return new OffsPair(TestJNI.OffsPairArray_getitem(swigCPtr, this, index), true);
  }

  public void setitem(int index, OffsPair value) {
    TestJNI.OffsPairArray_setitem(swigCPtr, this, index, OffsPair.getCPtr(value), value);
  }

  public OffsPair cast() {
    long cPtr = TestJNI.OffsPairArray_cast(swigCPtr, this);
    return (cPtr == 0) ? null : new OffsPair(cPtr, false);
  }

  public static OffsPairArray frompointer(OffsPair t) {
    long cPtr = TestJNI.OffsPairArray_frompointer(OffsPair.getCPtr(t), t);
