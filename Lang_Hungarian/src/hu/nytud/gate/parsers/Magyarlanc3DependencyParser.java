...
@CreoleResource(name = "3. Dependency Parser [HU] [magyarlanc 3.0]", 
				comment = "Requires sentences and tokens with lemma and pos features"
				)
public class Magyarlanc3DependencyParser extends AbstractLanguageAnalyser {
	...
	private void parseSentence(AnnotationSet annotationSet, Annotation sentence, int nsent) throws GateRuntimeException {
        ...
        // get form, lemma, pos for each token into a String[][]
	...
	private void addFeatures(Annotation token, String[] pdata, int governorTokenId) throws GateRuntimeException {
		...
		token.getFeatures().put("features", pdata[4]);
	}
